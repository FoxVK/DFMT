...
\item Deskriptor rozhraní pro odesílání zvuku - varianta se zapnutým přenosem.
	...
	\item Deskriptor koncového bodu - odesílání zvuku.
		\begin{enumerate}
		\item Deskriptor koncového bodu - odesílání zvuku (třídně specifický).
		\end{enumerate}
	\end{enumerate}
...
\hline
bSubFrameSize & 1B & 2 & Velikost jednoho vzorku v bytech. \\ %vysvětli jak je to se zaokrohlováním
\hline
bSubFrameResolution & 1B & 16 & Velikost jednoho vzorku v bitech. \\
\hline 
bSamFreqType & 1B & 1 & Způsob určení vzorkovací frekvence. (Diskrétní) \\
\hline
tSamFreq(1) & 2B & 48000 & Vzorkovací frekvence v Hz. \\
\hline 
\end{tabular} 
\end{center}
