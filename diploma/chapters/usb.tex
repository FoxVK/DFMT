...
TODO:Tabulka se zkrácenými string dekriptory.
...
Deskriptor konfigurace je nejvíce komplikovaný. Popisuje schopnosti zařízení a také jeho nároky na přenos popřípadě definují sady parametrů z nichž si může hostitel vybrat tu, která mu v daný okamžik nejvíce vyhovuje. I samotných konfigurací muže být definováno více. Hostitel potom zařízení jednu přidělí popříadě ji může změnit za jinou.\\
Deskriptor konfigurace je složen z dalších deskriptorů, které takto tvoří stromovou strukturu. V případě mého modulu vypadá tato struktura takto:
\begin{itemize}

\end{itemize}
TODO: configuration descriptor a jeho části
